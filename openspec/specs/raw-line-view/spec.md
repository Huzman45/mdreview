# raw-line-view Specification

## Purpose
Presenting a version as numbered source lines and anchoring comments to an
arbitrary line range, including ranges no rendered block covers on its own.
