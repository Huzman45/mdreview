# lan-address-discovery Specification

## Purpose
Choosing this machine's own private LAN address, so a moved DHCP lease does not
require the operator to look it up and retype it.
